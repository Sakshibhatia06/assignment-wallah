...
// ✅ Proper typing for async params
interface SubjectParams {
  params: Promise<{ slug: string }>;
}

// ✅ Generate metadata (Netlify build-safe)
export async function generateMetadata({ params }: SubjectParams): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${subject.title} | AssignmentsWallah`,
      description: subject.description,
      url: `https://assignmentswallah.com/subjects/${slug}`,
    },
    twitter: {
      title: `${subject.title} | AssignmentsWallah`,
      description: subject.description,
...
// ✅ The main SubjectPage component
export default async function SubjectPage({ params }: SubjectParams) {
  const { slug } = await params;
  const subject = subjects.find((s) => s.slug === slug);
