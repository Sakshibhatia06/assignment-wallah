        ...
        <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="mb-6 text-lg text-gray-700">
              Comprehensive Assignment Assistance With a{" "}
              <strong>No-AI Guarantee!</strong>
            </p>
          ...
          {/* ---------- RIGHT FORM ---------- */}
          <div className="w-full lg:w-1/2">
            <div className="rounded-2xl mt-4 border border-gray-200 bg-white/90 backdrop-blur-md p-6 shadow-xl transition hover:shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-md bg-[#2596be] py-3 font-semibold text-white transition hover:bg-[#1f85a9]"
                >
                  Do My Assignment
                </button>
              </form>
